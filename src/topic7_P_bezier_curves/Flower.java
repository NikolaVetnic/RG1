package topic7_P_bezier_curves;
...
public class Flower implements Drawing {
	...
	public void draw(View view) {
		...
		view.beginPath();
		view.moveTo(o);
		view.bezierCurveTo(ll1, ll1, l.add(Vector.polar(20, -0.36 * time)));
		...
		view.beginPath();
		view.moveTo(o);
		view.bezierCurveTo(rl1, rl2, r.add(Vector.polar(30, 0.27 * time)));
